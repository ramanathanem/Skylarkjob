...
export const Footer = () => {
  return (
    ...
    <div class="row">
      ...
      <div class="col-sm">
      <div class="row">
  <div class="col-6 col-sm-4"><h4 className='mt-4'>Job Seekers</h4>
  <ul style={{listStyle:"none"}}>
...
<ul style={{listStyle:"none",display:"flex",margin:"25px"}}>
    ...
    <hr/>
    <p className='text-center'>Copyright © 2024 Skylark HR Solutions Pvt Ltd HR Solutions Pvt Ltd.  <i class="bi bi-whatsapp"></i> <i class="bi bi-facebook"></i> <i class="bi bi-instagram"></i>
