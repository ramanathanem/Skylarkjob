...
const Jobrole = () => {
    const Data = [
        ...
        { id: 1, name: 'Account', img: account, level:'Midlevel',ctc:"$600-700" ,path:"/Account"},
        { id: 2, name: 'Digital Marketing', img: digital , level:'Midlevel',ctc:"$600-700", path:"/Digital"},
        { id: 3, name: 'Health care', img: health, level:'Midlevel',ctc:"$600-700" ,path:"/Health"},
        { id: 4, name: 'Manifacturing', img: manifacture , level:'Midlevel',ctc:"$600-700",path:"/Manifcutre"},
        { id: 1, name: 'Skin clinic', img: skin , level:'Midlevel',ctc:"$600-700",path:"/Skin"},
        { id: 2, name: 'Sales', img: sale, level:'Midlevel' ,ctc:"$600-700",path:"/Sale"},
        { id: 3, name: 'Operation', img: operation, level:'Midlevel',ctc:"$600-700" , path:"/Operation"},
        { id: 4, name: 'Miscellaneous', img: ms2 , level:'Midlevel',ctc:"$600-700",path:"/Ms"},
      ];
  return (
    <div>
