...
<div className='image-overlayss'>
  ...
  <div class="card-body">
    <h5 class="card-title">
    <h1 className="text-center" style={{fontFamily:"cursive", color:"orange"}}>Review<i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-half"></i></h1>
    </h5>
    <p class="card-text">
